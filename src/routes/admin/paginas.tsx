...
const pages = [
  { path: "/", label: "Portada Código Fuentes", description: "Menú principal de servicios." },
  {
    path: "/landing-pages",
    label: "Landing pages",
    description: "Selección de landing pages estratégicos.",
  },
  { path: "/quioscos", label: "Quioscos", description: "Menú de experiencias con carrito." },
  {
    path: "/multipaginas",
    label: "Multipáginas enlazadas",
    description: "Espacio reservado para nuevos proyectos.",
  },
  {
    path: "/mmd-eternal-dream",
    label: "More More Dream · Eternal Dream",
  ...
  { path: "/admin", label: "Panel privado", description: "Accesos de administración." },
  {
    ...
    description: "Base local de credenciales.",
  },
];
